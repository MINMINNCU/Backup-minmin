...
class ccommentHelperRecaptcha
{
	...
	public static function checkAnswer($privateKey, $ip, $challengeField, $responseFiel) {
		return ccommentRecaptchalib::recaptcha_check_answer($privateKey, $ip, $challengeField, $responseFiel);
	}
}