		...
		<table class="table">
			<tr>
				...
				<td nowrap="nowrap">
					...
					<?php echo JHtml::_('select.genericlist', array('0' => 'Not Been Accused', '1' => 'Been Accused','2' =>'Been Accused over 10 times'), 'filter_accused', 'class="inputbox"
						onchange="submitform();"', 'value', 'text', $this->state->get('filter.accused')); ?>
					<!-- <select id="filter_accused" name="filter_accused" class="inputbox"
					        onchange="this.form.submit();">
						<option value='0'>Not Been Accused</option>						
						<option value='1'>Been Accused</option>						
						<option value='10'>Been Accused over 10 times</option>
					</select> -->
				</td>
